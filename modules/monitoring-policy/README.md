...
|------|-------------|------|---------|:--------:|
| <a name="input_conditions"></a> [conditions](#input\_conditions) | List of alert conditions. | <pre>list(object({<br/>    display_name         = string<br/>    filter               = string<br/>    comparison           = string<br/>    threshold_value      = number<br/>    duration             = string<br/>    alignment_period     = optional(string, "60s")<br/>    per_series_aligner   = optional(string, "ALIGN_RATE")<br/>    cross_series_reducer = optional(string, "REDUCE_NONE")<br/>    group_by_fields      = optional(list(string), [])<br/>    trigger_count        = optional(number, 1)<br/>  }))</pre> | n/a | yes |
